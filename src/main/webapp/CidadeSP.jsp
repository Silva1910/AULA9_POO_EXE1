...
<div class="container" align="center">
    <form action="CidadeSP" method="post">
        <p class="title"><b> CIDADE DE SÃO PAULO </b></p>
        <table>
            <tr>
                <td><input class="input_data" type="number" id="numComodos" name="numComodos" step="1" placeholder="numero de comodos" oninput="validarValor(this);"  required></td>
            </tr>
            <tr>
