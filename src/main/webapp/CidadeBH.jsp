...
<title>CIDADE DE BELO HORIZONTE</title>
...
<div class="container" align="center">
    <form action="CidadeBH" method="post">
        <p class="title"><b> CIDADE DE BELO HORIZONTE </b></p>
        <table>
            <tr>
                <td><input class="input_data" type="number" id="numQuartos" name="numQuartos" step="1" placeholder="numero de quartos" oninput="validarValor(this);"  required></td>
            </tr>
            <tr>
